<template>
    <header class="text-gray-700 body-font shadow-lg  rounded overflow-hidden">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            >
                Checkout<span class="inline-block ml-1" v-text="'(' + cart.length +'items)'"></span>
            </router-link>
        </div>
    </header>
</template>
